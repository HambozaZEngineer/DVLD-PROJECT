...
namespace DVLDBusinessLayer
{
    public class TestAppointments
    {
        ...
        public static bool AddAppointmentValidation(int type, int licenseID)
        {
            return TestAppointmentsDataAccess.AddAppointmentValidation(type, licenseID);
        }

        public static int GetTrails(int type, int licenseID)
        {
            return TestAppointmentsDataAccess.GetTrails(type, licenseID);
        }
    }
}
